...
## Purpose
This note records the Archivarium Prime organization of **Forge Diaries — Public Volume 0.1**.

## Composition decisions

### Chapters
- `00-curators-introduction.md`
- `01-the-constitutional-prologue.md`
- `02-the-adversarial-crucible.md`
- `03-governance-memory-and-form.md`
- `04-threshold-to-public-language.md`

### Essays promoted outside the volume
...
2. Part I — The Constitutional Prologue
3. Part II — The Adversarial Crucible
...
- Part I: emergence and differentiation
- Part II: pressure and correction
