...
- `docs/foundations/about-this-repository.md`
- `docs/foundations/public-method.md`
- `docs/foundations/glossary.md`
- `docs/foundations/faq.md`
- `docs/foundations/research-agenda.md`
...
- `docs/foundations/source-of-truth-map.md`
